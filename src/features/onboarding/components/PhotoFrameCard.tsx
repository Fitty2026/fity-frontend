...
const PhotoFrameCard = ({ imageSrc, showCheck = false, alt = '체형 안내' }: PhotoFrameCardProps) => (
  <div className="flex flex-col items-center gap-3">
    <div className="relative flex h-[340px] w-[220px] items-center justify-center overflow-hidden rounded-3xl border border-neutral-100 bg-neutral-100">
      {imageSrc && <img src={imageSrc} alt={alt} className="h-full w-full object-contain" />}
      {showCheck && (
