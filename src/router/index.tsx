...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: '/mypage/profile/style/select',
        element: (
          <ProtectedRoute>
            <StyleSelectPage />
          </ProtectedRoute>
